...
# This is a httpks variation of the test.
...
prepare() {
    ...
    sed -i -e 's#@KSTEST_STATIC_IP@#192.168.100.10#g' -e 's#@KSTEST_STATIC_NETMASK@#255.255.255.0#g' -e 's#@KSTEST_STATIC_GATEWAY@#192.168.100.1#g' ${ks}

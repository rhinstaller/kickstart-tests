...
kernel_args() {
    ...
    echo ${DEFAULT_BOOTOPTS} ip=${KSTEST_NETDEV1}:dhcp ${ip_static_boot_config}
}
...
prepare() {
    ...
    echo "ip_static_boot_config=ip=192.168.100.5::192.168.100.1:255.255.255.0::${KSTEST_NETDEV2}:none" > ${tmpdir}/ip_static_boot_config

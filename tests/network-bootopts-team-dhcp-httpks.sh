...
TESTTYPE=${TESTTYPE:-"network skip-on-rhel-10 skip-on-centos-10"}

. ${KSTESTDIR}/libs/functions.sh

kernel_args() {
    . ${tmpdir}/ks_url
    echo ${DEFAULT_BOOTOPTS} ip=${KSTEST_NETDEV1}:dhcp ip=team0:dhcp  team=team0:${KSTEST_NETDEV2},${KSTEST_NETDEV3} inst.ks=${ks_url}
}
